...
LENSES = ["ev", "bayes", "skeptic", "domain"]
SONNET = ["panel-evidential", "panel-bayesian", "panel-skeptic", "panel-domain"]
RNG = random.Random(2026)

ev = store.read_events(ROOT / "covid-graph")
...
for nid, label in (("n001", "zoonotic spillover"), ("n002", "research incident")):
