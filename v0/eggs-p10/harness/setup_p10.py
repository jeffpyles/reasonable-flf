#!/usr/bin/env python3
"""Seed eggs-p10 from the shared eggs scaffold (p6 events minus ratings), write
...
def gen_assignment():
    ...
    nodes = [json.loads(l)["payload"]["id"]
             for l in (P10 / "events.jsonl").read_text().splitlines()
...
if __name__ == "__main__":
    ...
    print(f"seeded eggs-p10: {ns} scaffold events; enforced blind; assignment {na} agents x {nn} nodes")
