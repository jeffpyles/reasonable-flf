...
## How to rate (CLI — always `--data eggs-p2` and your assigned `--bloc`)
```
cd /home/user/reasonable/v0
python3 graph.py get-node n007 --data eggs-p2 --json      # READ the item first
python3 graph.py rate --agent <you> --target n007 --dim A --value 4.0 --bloc <your-bloc> --data eggs-p2 --json
python3 graph.py rate --agent <you> --target phrasing:n007:p0 --dim R --value 3.5 --bloc <your-bloc> --data eggs-p2 --json
python3 graph.py rate --agent <you> --target phrasing:n007:p0 --dim C --value 4.5 --bloc <your-bloc> --data eggs-p2 --json
python3 graph.py rate --agent <you> --target e003 --dim A --value 3.0 --bloc <your-bloc> --data eggs-p2 --json
```
...
- **You may add a node or edge** if you see a clear gap, but your main job is rating. Use
  `search "<kw>" --data eggs-p2` before adding anything, to avoid duplicates.
