#!/usr/bin/env python3
"""eggs-p8 analysis — de-confound DISPOSITION from MODEL, and validate the
...
Run: python3 eggs-p8/harness/analyze_p8.py    (from repo root, after the run)
"""
import json
import math
import random
...
if not items:
    print("No eggs-p8 ratings yet — run workflow_p8.js first.")
    sys.exit(0)
...
print("\nDone. See eggs-p8/FINDINGS.md for the synthesis.")
