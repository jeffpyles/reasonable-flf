# eggs-p8 — rate every assigned claim from your own worldview (blind)
...
(`eggs-p8/harness/personas/<your-id>.md`) — it says who you are and how you see this topic — and your
assignment (`eggs-p8/harness/assign/<your-id>.tsv`, node ids to rate on dim A). For EACH node: read it
...
python3 graph.py rate --agent <your-id> --target <nid> --dim A --value <0.0-5.0> --bloc b1 --data eggs-p8 --json
```
